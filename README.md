...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=300&section=header&text=Arpit%20Bhojani&fontSize=78&animation=twinkling&fontAlignY=40&fontColor=ffffff&desc=Python%20Developer%20%E2%80%A2%20ML%20Engineer%20%E2%80%A2%20Django%20Developer&descAlignY=62&descAlign=50&descSize=18&descColor=a8d8ff" width="100%" alt="Header"/>
...
<a href="mailto:arpitbhojani.contact@gmail.com">
  <img src="https://img.shields.io/badge/Gmail-arpitbhojani.contact%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white&labelColor=1a1a2e"/>
</a>
&ensp;
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=15&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Building+backends+that+scale+under+pressure...;Training+models+that+see+the+world...;Breaking+the+GIL+one+pipeline+at+a+time...;Turning+raw+ideas+into+deployed+systems.;Prompting+Claude+to+think+alongside+me..." alt="Typing SVG"/>
...
| **Backend & Web** | Django · REST API · Token Auth |
...
<img src="https://img.shields.io/badge/Anthropic%20API-CC785C?style=for-the-badge&logo=anthropic&logoColor=white" alt="Anthropic API"/>
...
<img src="https://img.shields.io/badge/Prompt%20Engineering-191919?style=for-the-badge&logo=anthropic&logoColor=white" alt="Prompt Engineering"/>

**System prompts · Context windows · Retrieval**

Designing prompts that hold up under edge cases. Structuring system prompts for role clarity, injecting retrieved chunks cleanly, and keeping token budgets tight. Prompt engineering as a craft — not just trial and error. The model is only as good as the instructions it receives.
...
<img src="https://img.shields.io/badge/LangGraph-6D28D9?style=for-the-badge&logo=graphql&logoColor=white" alt="LangGraph"/>
...
<img src="https://img.shields.io/badge/Claude%20API-CC785C?style=for-the-badge&logo=anthropic&logoColor=white" alt="Claude API"/>
...
|:---:|:---|:---|
| ✅ **Done** | **Computer Vision** | YOLO · OpenCV · ROI · VisionForge · Sentrix-AI |
| ✅ **Done** | **RAG & Agents** | Ingestion Pipelines · Terminal AI Agent · Claude API RAG |
| ✅ **Done** | **Document Processing** | PyPDF · PyMuPDF · PDF Slicer 2.0 · Multiprocessing Pipelines |
| ✅ **Done** | **Web Automation** | GhostFetch · Playwright · Headless Scraping · Pydantic |
| ✅ **Done** | **Anthropic Stack** | Claude API · Claude Code · Prompt Engineering · Agentic Workflows |
| 🔄 **Active** | **Transformers** | Hugging Face · Fine-tuning · Embeddings |
| 🔄 **Active** | **LLM Orchestration** | LangChain · LangGraph · Multi-Agent Systems |
| 🔄 **Active** | **Local AI Stack** | Ollama · Private LLMs · On-device Inference |
| 🔄 **Active** | **Data Validation** | Pydantic-AI · UV · Advanced Type Systems |
| 📍 **Next** | **Deep Learning** | Neural Architectures · Backprop · CNNs · Attention |
